...
for (const bt of btData) {
  ...
  const restDays = [
    ...
    ['Who Uses ' + bt.name, sharedImages[2], bt.name + ' is ideal for a wide range of businesses including ' + bt.businesses + '. Whatever your specific niche within this market, our system can be tailored to deliver leads that match your ideal customer profile. You choose the postcode areas, we deliver the opportunities.'],
    ...
    ['9amLeads vs The Competition', sharedImages[4], 'Exclusive leads vs shared leads. Fixed pricing vs pay per lead. Delivered at 9am vs random timing. CRM integration vs no integration. 7 day free trial vs no trial. For ' + bt.name.toLowerCase() + ', the choice is clear.'],
