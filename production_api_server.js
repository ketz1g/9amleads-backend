...
function generateLeadEmailHTML(customer, leads) {
  ...
  for (var i = 0; i < leads.length; i++) {
    ...
    if (productName === 'planning' && d.council) {
      ...
      body += '<div style="border-top:1px solid rgba(0,0,0,0.04);padding-top:10px;padding-bottom:2px"><a href="https://publicaccess.' + councilDomain + '.gov.uk/online-applications/search.do?action=simple" target="_blank" style="display:block;text-align:center;padding:8px 0;background:' + accent + ';color:#fff;text-decoration:none;border-radius:8px;font-size:12px;font-weight:600">\uD83D\uDD0D Apply on Portal</a></div>';
