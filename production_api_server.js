...
function getCampaignEmailHTML(customer, template) {
  ...
  return '<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><style>[data-ogsc] body,[data-ogsc] table,[data-ogsc] td,[data-ogsc] div{background-color:#ffffff!important;color:#222!important}@media(prefers-color-scheme:dark){body,table,td,div{background-color:#ffffff!important;color:#222!important}}</style></head><body style="margin:0;padding:0;background:#f4f6f9;font-family:Inter,Arial,sans-serif"><table width="100%" cellpadding="0" cellspacing="0"><tr><td align="center" style="padding:24px;background-color:#f4f6f9"><table width="560" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style="max-width:560px;width:100%;background-color:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 2px 16px rgba(0,0,0,0.06)"><tr><td style="background-color:#ffffff;padding:28px;border-bottom:1px solid rgba(0,0,0,0.06);text-align:center"><div style="display:inline-flex;align-items:center;gap:8px"><div style="width:34px;height:34px;border-radius:8px;display:flex;align-items:center;justify-content:center;background:linear-gradient(135deg,rgba(14,165,233,0.12),rgba(6,182,212,0.08))"><svg width="20" height="20" viewBox="0 0 100 100" fill="none"><circle cx="50" cy="50" r="40" stroke="#333" stroke-width="5"/><circle cx="50" cy="50" r="3" fill="#0ea5e9"/><line x1="50" y1="50" x2="50" y2="17" stroke="#0ea5e9" stroke-width="4.5" stroke-linecap="round"/><line x1="50" y1="50" x2="23" y2="50" stroke="#333" stroke-width="5.5" stroke-linecap="round"/></svg></div><div style="font-family:Outfit,sans-serif;font-size:20px;font-weight:800;color:#111;letter-spacing:-.5px">9am<span style="color:' + accent + '">Leads</span></div></div><p style="color:#666;font-size:11px;margin-top:6px">' + customer.company + '</p></td></tr><tr><td style="background-color:#ffffff;padding:24px 28px">' + (templates[template] || templates.trial_day1) + '</td></tr><tr><td style="background-color:#ffffff;padding:20px 28px;border-top:1px solid rgba(0,0,0,0.06);text-align:center"><p style="color:#888;font-size:11px;margin:0">9am Leads Ltd \u00b7 Company No. 17168176 \u00b7 <a href="https://www.9amleads.com/privacy.html" style="color:#0ea5e9">Unsubscribe</a></p></td></tr></table></td></tr></table></body></html>';
}
