...
const PLANS = [
  ...
  { id: 'growth',  name: 'Pro',  tier: 2 },
  { id: 'power',   name: 'Enterprise',   tier: 3 }
];
...
const PRICING = {
  newbusiness: {
    ...
    plans: [
      { id: 'nb-starter',  name: 'Starter', price: 2500, interval: 'week', leadsMin: 1,  leadsMax: 5,  leadsLabel: '1–5 estimated leads/day', tier: 1 },
      { id: 'nb-growth',   name: 'Pro',  price: 4900, interval: 'week', leadsMin: 5,  leadsMax: 15, leadsLabel: '5–15 estimated leads/day',  tier: 2 },
      { id: 'nb-power',    name: 'Enterprise',   price: 9900, interval: 'week', leadsMin: 15, leadsMax: 40, leadsLabel: '15–40 estimated leads/day', tier: 3 }
    ]
  },
  planning: {
    name: 'Planning Permission Leads',
    plans: [
      { id: 'plan-starter', name: 'Starter', price: 2500, interval: 'week', leadsMin: 1,  leadsMax: 3,  leadsLabel: '1–3 estimated leads/day',  tier: 1 },
      { id: 'plan-growth',  name: 'Pro',  price: 4900, interval: 'week', leadsMin: 3,  leadsMax: 10, leadsLabel: '3–10 estimated leads/day',  tier: 2 },
      { id: 'plan-power',   name: 'Enterprise',   price: 9900, interval: 'week', leadsMin: 10, leadsMax: 25, leadsLabel: '10–25 estimated leads/day', tier: 3 }
    ]
  },
  probate: {
    name: 'Probate Leads',
    plans: [
      { id: 'prob-starter', name: 'Starter', price: 2500, interval: 'week', leadsMin: 0, leadsMax: 2,  leadsLabel: '0–2 estimated leads/day',  tier: 1 },
      { id: 'prob-growth',  name: 'Pro',  price: 4900, interval: 'week', leadsMin: 2, leadsMax: 6,  leadsLabel: '2–6 estimated leads/day',  tier: 2 },
      { id: 'prob-power',   name: 'Enterprise',   price: 9900, interval: 'week', leadsMin: 5, leadsMax: 15, leadsLabel: '5–15 estimated leads/day', tier: 3 }
    ]
  },
  moving: {
    name: 'Moving Leads',
    plans: [
      { id: 'mov-starter', name: 'Starter', price: 2500, interval: 'week', leadsMin: 1,  leadsMax: 5,  leadsLabel: '1–5 estimated leads/day',  tier: 1 },
      { id: 'mov-growth',  name: 'Pro',  price: 4900, interval: 'week', leadsMin: 5,  leadsMax: 15, leadsLabel: '5–15 estimated leads/day',  tier: 2 },
      { id: 'mov-power',   name: 'Enterprise',   price: 9900, interval: 'week', leadsMin: 15, leadsMax: 35, leadsLabel: '15–35 estimated leads/day', tier: 3 }
    ]
  },
  tenders: {
    name: 'Public Sector Tender Leads',
    plans: [
      { id: 'tend-starter', name: 'Starter', price: 2500, interval: 'week', leadsMin: 3,  leadsMax: 5,  leadsLabel: '3–5 estimated tenders/day',  tier: 1 },
      { id: 'tend-growth',  name: 'Pro',  price: 4900, interval: 'week', leadsMin: 5,  leadsMax: 15, leadsLabel: '5–15 estimated tenders/day',  tier: 2 },
      { id: 'tend-power',   name: 'Enterprise',   price: 9900, interval: 'week', leadsMin: 15, leadsMax: 40, leadsLabel: '15–40 estimated tenders/day', tier: 3 }
    ]
  }
};
