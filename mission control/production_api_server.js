...
function generateLeadEmailHTML(customer, leads) {
  ...
  body += '<p style="color:rgba(255,255,255,0.7);font-size:11px;margin:14px 0 0"><a href="mailto:hello@9amleads.com?subject=Lead%20Issue" style="color:rgba(255,255,255,0.8);text-decoration:underline">Lead issue? Contact us &rarr;</a></p>';
