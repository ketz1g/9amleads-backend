  ...
  try {
    ...
    /*try {
      ...
      await sendBrevoEmail(
        ...
        '<div style="font-family:Arial,Helvetica,sans-serif;color:#e2e8f0"><div style="text-align:center;margin-bottom:16px"><span style="display:inline-block;width:34px;height:34px;border-radius:9px;text-align:center;line-height:34px;font-size:15px;background:linear-gradient(135deg,#6366f1,#8b5cf6);margin-right:5px;vertical-align:middle;color:#fff;font-weight:900">9</span><span style="vertical-align:middle;font-size:20px;font-weight:900;color:#f1f5f9">am Leads</span></div><h2 style="font-size:20px;font-weight:800;color:#f1f5f9;margin:0 0 12px;text-align:center">Welcome to 9am Leads!</h2><p style="font-size:14px;color:#94a3b8;line-height:1.7;margin:0 0 16px;text-align:center">Please verify your email address by clicking the button below:</p><table width="100%" cellpadding="0" cellspacing="0"><tr><td align="center" style="padding:4px 0 16px"><a href="' + verifyUrl + '" style="display:inline-block;padding:12px 32px;background:linear-gradient(135deg,#6366f1,#8b5cf6);color:#fff;text-decoration:none;border-radius:50px;font-size:14px;font-weight:700">Verify Email</a></td></tr></table><p style="font-size:13px;color:#64748b;line-height:1.6;margin:0;text-align:center">Your free 7-day trial has started. You\'ll receive your first leads at 9am tomorrow.</p></div>'
      );
    } catch (e) {
  ...
  try {
    ...
    try {
      await sendBrevoEmail(
        ...
        '<div style="font-family:Arial,Helvetica,sans-serif;color:#e2e8f0"><div style="text-align:center;margin-bottom:16px"><span style="display:inline-block;width:34px;height:34px;border-radius:9px;text-align:center;line-height:34px;font-size:15px;background:linear-gradient(135deg,#6366f1,#8b5cf6);margin-right:5px;vertical-align:middle;color:#fff;font-weight:900">9</span><span style="vertical-align:middle;font-size:20px;font-weight:900;color:#f1f5f9">am Leads</span></div><h2 style="font-size:20px;font-weight:800;color:#f1f5f9;margin:0 0 12px;text-align:center">Password Reset</h2><p style="font-size:14px;color:#94a3b8;line-height:1.7;margin:0 0 16px;text-align:center">Click the button below to reset your password. This link expires in 1 hour.</p><table width="100%" cellpadding="0" cellspacing="0"><tr><td align="center" style="padding:4px 0 16px"><a href="' + resetUrl + '" style="display:inline-block;padding:12px 32px;background:linear-gradient(135deg,#6366f1,#8b5cf6);color:#fff;text-decoration:none;border-radius:50px;font-size:14px;font-weight:700">Reset Password</a></td></tr></table><p style="font-size:13px;color:#64748b;line-height:1.6;margin:0;text-align:center">If you did not request this, please ignore this email.</p></div>'
      );
    } catch (e) {
