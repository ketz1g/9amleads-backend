  ...
  try {
    ...
    try {
      await sendBrevoEmail(
        ...
        '<div style="font-family:Arial,Helvetica,sans-serif;color:#e2e8f0"><div style="text-align:center;margin-bottom:16px"><span style="display:inline-block;width:34px;height:34px;border-radius:9px;text-align:center;line-height:34px;font-size:15px;background:linear-gradient(135deg,#0ea5e9,#6366f1);margin-right:5px;vertical-align:middle;color:#fff;font-weight:900">9</span><span style="vertical-align:middle;font-size:20px;font-weight:900;color:#f1f5f9">am Leads</span></div><h2 style="font-size:20px;font-weight:800;color:#f1f5f9;margin:0 0 12px;text-align:center">Password Reset</h2><p style="font-size:14px;color:#cbd5e1;line-height:1.7;margin:0 0 16px;text-align:center">Click the button below to reset your password. This link expires in 1 hour.</p><table width="100%" cellpadding="0" cellspacing="0"><tr><td align="center" style="padding:4px 0 16px"><a href="' + resetUrl + '" style="display:inline-block;padding:12px 32px;background:linear-gradient(135deg,#0ea5e9,#6366f1);color:#fff;text-decoration:none;border-radius:50px;font-size:14px;font-weight:700">Reset Password</a></td></tr></table><p style="font-size:13px;color:#94a3b8;line-height:1.6;margin:0;text-align:center">If you did not request this, please ignore this email.</p></div>'
      );
    } catch (e) {
...
function generateLeadEmailHTML(customer, leads) {
  ...
  if (areasLabel) body += '<p style="color:#cbd5e1;font-size:11px;margin:0;text-transform:uppercase;letter-spacing:3px;font-weight:600">' + areasLabel + '</p>';
  body += '</td></tr>';
  ...
  body += '<p style="color:#94a3b8;font-size:13px;margin:0 0 20px">Your daily opportunities for ' + new Date().toLocaleDateString('en-GB', { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric' }) + '.</p>';
  ...
  body += '<p style="font-size:12px;color:#94a3b8;line-height:1.6;margin:0;padding:12px 16px;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.06);border-radius:10px">' + aboutText + '</p>';
  body += '</td></tr>';
  ...
  for (var i = 0; i < leads.length; i++) {
    ...
    if (subtitle) body += '<div style="font-size:13px;color:#94a3b8;margin-top:4px">' + subtitle + '</div>';
    ...
    if (chips.length > 0) {
      ...
      for (var c = 0; c < chips.length; c++) {
        body += '<span style="display:inline-block;padding:4px 10px;margin:0 4px 4px 0;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.06);border-radius:8px;font-size:12px;color:#cbd5e1;white-space:nowrap">' + chips[c].icon + ' ' + chips[c].text + '</span>';
      }
      body += '</div>';
    }
    ...
    if (hasEmail || hasPhone || hasWebsite) {
      ...
      if (hasEmail) body += '<div style="font-size:12px;color:#94a3b8;margin-bottom:3px">\u2709\uFE0F <a href="mailto:' + (d.ownerEmail || d.buyerEmail || d.legalAdvisorEmail || d.email) + '" style="color:#38bdf8;text-decoration:none">' + (d.ownerEmail || d.buyerEmail || d.legalAdvisorEmail || d.email) + '</a></div>';
      if (hasPhone) body += '<div style="font-size:12px;color:#94a3b8;margin-bottom:3px">\uD83D\uDCDE ' + (d.phone || d.ownerPhone || d.buyerPhone || d.legalAdvisorPhone || d.mobile) + '</div>';
      if (hasWebsite) body += '<div style="font-size:12px;color:#94a3b8;margin-bottom:3px">\uD83C\uDF10 <a href="http://' + d.website.replace(/^https?:\/\//, '') + '" style="color:#38bdf8;text-decoration:none" target="_blank">' + d.website + '</a></div>';
      body += '</div>';
    }
  ...
  body += '<a href="' + pricingLink + '" style="display:inline-block;padding:10px 30px;border:1px solid rgba(255,255,255,0.15);color:#cbd5e1;text-decoration:none;border-radius:50px;font-weight:600;font-size:12px">View ' + (customer.product ? getLeadTypeRule(customer.product).name : 'Pricing') + '</a>';
  body += '<p style="color:rgba(255,255,255,0.7);font-size:11px;margin:14px 0 0"><a href="' + PUBLIC_URL + '" style="color:rgba(255,255,255,0.6);text-decoration:underline">9amLeads.com</a> &bull; <a href="mailto:hello@9amleads.com?subject=Lead%20Issue" style="color:rgba(255,255,255,0.8);text-decoration:underline">Lead issue? Contact us &rarr;</a></p>';
  ...
  body += '</tr></table>';
  body += '<p style="color:rgba(255,255,255,0.5);font-size:10px;margin:0 0 4px;letter-spacing:.4px">9am Leads Ltd &bull; Company No. 17168176</p>';
  body += '<p style="color:rgba(255,255,255,0.45);font-size:9px;margin:0 0 12px;letter-spacing:.3px"><a href="mailto:hello@9amleads.com" style="color:#38bdf8;text-decoration:underline">hello@9amleads.com</a> &bull; <a href="https://www.9amleads.com/privacy.html" style="color:#38bdf8;text-decoration:underline">Privacy Policy</a></p>';
  body += '<p style="color:rgba(255,255,255,0.4);font-size:8px;margin:0;letter-spacing:.4px">Fresh exclusive opportunities delivered at 9am every morning &bull; 9amLeads.com</p>';
